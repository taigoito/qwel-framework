...
add_action('after_setup_theme', 'oasis_ironwork_setup');


// Widgets

function oasis_ironwork_widgets_init()
{
  register_sidebar([
    'name' => 'Blog Sidebar',
    'id' => 'blog-sidebar',
...
add_action('widgets_init', 'oasis_ironwork_widgets_init');
...
$copyright = date('Y') . ' Kaoru Watanabe';

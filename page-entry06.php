...
<html lang="ja">
<head>
<title>水栓品研磨 | 募集職種 | 株式会社 プロダクトマイスター RECRUITサイト</title>
<meta charset="utf-8">
...
<tr>
<th>給与</th>
<td>時間給1,200円（経験・能力により時給UP）<br />
給与支給例<br />
フルタイムの場合<br />
月額207,360円+通勤手当（月平均21.6日出勤で計算）<br />
通勤手当（上限15,000円）</td>
</tr>
<tr>
<th>待遇・福利厚生</th>
...
<tr>
<th>休日・休暇</th>
<td>2020年度会社カレンダーに準ずる<br />
週休2日制（土日祝日休み）※土曜日出社日もあり（第二土曜日）<br />
年間休日105日（年末年始・夏季休暇含む）<br />
有給休暇あり（当社規定による）</td>
</tr>
<tr>
<th>勤務地</th>
<td>本社工場　福井県鯖江市糺町21-1</td>
</tr>
<tr>
<th>勤務時間</th>
<td>希望勤務時間相談の上考慮（8：30～17：30の間で1日5時間～8時間）<br />
フルタイムの場合<br />
実働8時間　8：30～17：30<br />
休憩1時間　10：00～10：10<br />
　　　　　 12：00～12：40<br />
　　　　　 15：00～15：10<br />
残業あり　月平均15時間～20時間</td>
</tr>
</table>
</div>
<div class="envir">
...
<img src="<?php echo QWEL_THEME_URI . '/assets/img/jobs/img18.jpg'; ?>" class="img-responsive center-block">
<h5>研磨機（バフ研磨）</h5>
<p>バフ研磨機を使用し、眼鏡部品、水栓品の研磨をお願いしております。</p>
</div>
<div class="col-md-4 col-sm-6">
<img src="<?php echo QWEL_THEME_URI . '/assets/img/jobs/img19.jpg'; ?>" class="img-responsive center-block">
<h5>研磨作業</h5>
<p>20代～60代まで幅広い方が業務に携わっております。</p>
</div>
<div class="col-md-4 col-sm-6">
<img src="<?php echo QWEL_THEME_URI . '/assets/img/jobs/img20.jpg'; ?>" class="img-responsive center-block">
<h5>休憩室（冷暖房完備）</h5>
<p>給湯器、冷蔵庫、ウォーターサーバーがありますので、ご自由にお使い頂けます。</p>
</div>
</div>
</div>
<div class="staff">
...
<div class="row">
<div class="col-md-3 col-sm-4"><img src="<?php echo QWEL_THEME_URI . '/assets/img/jobs/img21.jpg'; ?>" class="img-responsive center-block"></div>
<div class="col-md-9 col-sm-8">
<h5>技術を活かす</h5>
<p class="bbTxt">本社製造　研磨担当<br />
鈴木　徹<br />
2015年11月入社</p>
<p>年齢を重ねるにつれ立ち作業がつらく、経験のあった座り作業の『研磨』を選択いたしました。日々勉強を重ね、お客様の要望に応えていく中で、双方満足できる製品をという気持ちで従事しております。年齢を重ねてもありがとうの言葉を頂けるとうれしいですね。研磨職人の高齢化が進む中、当社は若い社員の育成にも力を入れています。研磨という奥深い技術を一緒に学びましょう。お待ちしております。</p>
</div>
</div>
</div>
<div id="entryForm">

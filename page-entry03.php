...
<html lang="ja">
<head>
<title>ろ過成形作業 | 募集職種 | 株式会社 プロダクトマイスター RECRUITサイト</title>
<meta charset="utf-8">
...
<br />
ろ過・成形業務<br />
1. 材料準備　電動フォークリフト（資格不要）で、ろ過機前に材料パレットを運搬<br />
2. ろ過機準備　ろ過専用の網をろ過機にセット<br />
3. 材料投入　ろ過機に準備した材料を投入<br />
4. 成形　ろ過機より搬出された製品を既定の大きさにカット<br />
5. 重量調整　カットした製品を重量機に乗せ、既定の重量に調整<br />
6. 製品排出　自動梱包機にラインで送られ、自動梱包後、出荷場へ搬送<br />
<br />
出荷・梱包業務<br />
1. 梱包　ラインで搬送された製品を段ボール自動梱包機で梱包<br />
2. 仕分　ロボットアームにより出荷パレットへ製品別に仕分し荷積み<br />
3. 出荷準備　荷積み完了後にフォークリフト（資格要）で運搬、ビニールで固定し、出荷</p>
</div>
<div class="info">
<h4 class="subTtl">募集要項</h4>
<table class="mainTbl">
<tr>
<th>仕事内容</th>
<td>シリコーン樹脂製品の梱包、出荷業務<br />
シリコーン樹脂のろ過、成形</td>
</tr>
<tr>
<th>求める人材・資格</th>
<td>高卒以上<br />
普通自動車運転免許<br />
フォークリフト免許取得者優遇　※フォークリフト免許なくてもOK<br />
入社後、フォークリフト2t以上の資格取得制度あり(取得費用負担あり)<br />
未経験者大歓迎</td>
</tr>
<tr>
<th>給与</th>
...
<br />
【正社員】<br />
基本給　　　 155,000円～180,000円<br />
皆勤手当　　 5,000円<br />
通勤手当　　 上限15,000迄<br />
家族手当　　 会社規定に準ずる<br />
交替勤手当　 会社規定に準ずる<br />
資格手当　　 会社規定に準ずる<br />
別途手当　　 深夜手当・時間外手当・休日手当<br />
賞与あり　　 会社業績により支給<br />
試用期間　　 3ヶ月（待遇変動なし）</td>
</tr>
<tr>
<th>待遇・福利厚生</th>
<td>社会保険完備　健康・厚生年金・雇用・労災<br />
介護休業取得実績　あり</td>
</tr>
<tr>
<th>休日・休暇</th>
<td>4勤2休（シフト制）<br />
勤務5日（月～金）休日2日（土・日）<br />
　1週間ごとに①②③の勤務を交替<br />
　1班　①→②→③<br />
　2班　②→③→①<br />
　3班　③→①→②<br />
...
<tr>
<th>勤務時間</th>
<td>3交替（8：00～16：30、16：00～24：30、0：00～8：30）<br />
勤務時間 8時間30分<br />
実働 7.5時間<br />
休憩 1時間<br />
残業　月平均5時間程度あり</td>
...
<img src="<?php echo QWEL_THEME_URI . '/assets/img/jobs/img09.png'; ?>" class="img-responsive center-block">
<h5>キャリアアップ制度</h5>
<p>当社ではキャリアアップ制度として人事評価を実施しております。個人目標と会社要望のギャップを埋め、互いに相乗効果もたらす仕組みを実施しております。</p>
</div>
<div class="col-md-4 col-sm-6">
<img src="<?php echo QWEL_THEME_URI . '/assets/img/jobs/img10.png'; ?>" class="img-responsive center-block">
<h5>事業所年齢層</h5>
<p>30代～60代までの幅広い年齢層の社員が働いております。</p>
</div>
<div class="col-md-4 col-sm-6">
<img src="<?php echo QWEL_THEME_URI . '/assets/img/jobs/img11.png'; ?>" class="img-responsive center-block">
<h5>事業所社員の勤続年数</h5>
<p>生産が安定しているため、勤続年数3年以上の社員が6割勤務しており、指導教育も細かく対応いたします。</p>
</div>
</div>
</div>
<div class="staff">
...
<div class="row">
<div class="col-md-3 col-sm-4"><img src="<?php echo QWEL_THEME_URI . '/assets/img/jobs/img12.jpg'; ?>" class="img-responsive center-block"></div>
<div class="col-md-9 col-sm-8">
<h5>新設備導入による生産体制強化！</h5>
<p class="bbTxt">請負第三事業所　事業所責任者<br />
横井　秀之<br />
2008年入社</p>
<p>新元号『令和』の時代が始まりました。私たちの現場では新設備導入により生産体制も強化され、今後ますます受注が多くなる『やりがいのある』お仕事です。正直に言うと『体力勝負』のお仕事でしたが、設備導入により大幅な軽減ができました。社員一同一緒にモノづくりをしていきますので、安心してご応募ください。お待ちしております。</p>
</div>
</div>
</div>
<div id="entryForm">
...
<td>
<input type="text" value="" name="name" class="form-control col-6"/>
...
<tr>
<th>氏名(カナ)<span>必須</span></th>
<td>
<input type="text" value="" name="kana" class="form-control col-6"/>
...
<input type="text" name="zip" value="" id="zip" class="form-control col-3" size="14" onKeyUp="AjaxZip3.zip2addr(this,'','address','address');" placeholder="" />
<input type="hidden" name="field[]" value="zip" />
<input type="hidden" name="zip:c" value="a" />
<input type="hidden" name="zip:v#maxLength" value="8" />
<input type="hidden" name="zip:v#minLength" value="7" />
<input type="hidden" name="zip:v#digits" />
...
<td>
<input type="text" name="address" value="" id="address" class="form-control" size="50" />
...
<td>
<input type="text" value="" name="tel" class="form-control col-6"/>
...
<th>ご希望のご連絡方法</th>
<td>
<label><input type="radio" name="cont" value="電話" />電話</label>
<label><input type="radio" name="cont" value="メール" />メール</label>
<input type="hidden" name="field[]" value="cont" />
</td>
</tr>
<tr>
<th>性別</th>
...
<input type="hidden" name="field[]" value="sex" />
</td>
</tr>
<tr>
<th>年齢</th>
<td>
<input type="text" value="" name="age" class="form-control col-3"/>
...
<th>最終学歴</th>
<td>
<input type="text" value="" name="edu" class="form-control col-6"/>
<input type="hidden" name="field[]" value="edu" />
</td>
</tr>
</table>
